...
export const JoinLeagueModal: React.FC<JoinLeagueModalProps> = ({ isOpen, onClose, onSubmit, leagueName }) => {
        ...
        <div className="px-10 pt-10 pb-8 text-center">
          ...
          <div className="mt-8 flex flex-col gap-2.5">
            <button
              ...
              className="group relative w-full inline-flex justify-center items-center rounded-2xl px-6 py-3.5 bg-gradient-to-br from-emerald-500 to-emerald-600 text-base font-bold text-white shadow-[0_8px_15px_-3px_rgba(16,185,129,0.3)] hover:shadow-[0_12px_20px_-3px_rgba(16,185,129,0.4)] hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-300 overflow-hidden"
            >
            ...
            <button
              type="button"
              onClick={onClose}
              className="w-full inline-flex justify-center items-center rounded-2xl px-6 py-3 text-sm font-bold text-slate-400 hover:text-slate-600 hover:bg-slate-50 transition-all duration-300"
            >
              Cancel
            </button>
          </div>
