...
export const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const handleLogout = () => {
    setIsProfileOpen(false);
    alert("Signing out of Syndicate Vault...");
    navigate('/');
  };
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center">
              <Link to="/" className="flex-shrink-0 flex items-center space-x-3 group">
                <div className="bg-yellow-400 p-2 rounded-xl transform group-hover:rotate-12 transition-transform duration-300 shadow-lg shadow-yellow-400/20">
                    <Trophy className="h-6 w-6 text-emerald-900" />
                </div>
                <span className="font-black text-2xl tracking-tighter uppercase italic">Coupon Busters</span>
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
             <div className="flex items-center space-x-2 grayscale opacity-50">
                ...
                <span className="font-black text-sm text-slate-400 tracking-tighter uppercase italic">Coupon Busters</span>
             </div>
